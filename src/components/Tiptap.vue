...
.collapse-icon:hover,
h1:hover .collapse-icon,
h2:hover .collapse-icon,
h3:hover .collapse-icon,
h4:hover .collapse-icon,
h5:hover .collapse-icon,
h6:hover .collapse-icon {
  visibility: visible;
}
*[fold='true'] .collapse-icon{
